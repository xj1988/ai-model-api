...
public class DefaultUsageTests {
    ...
    void testArbitraryNativeUsageMap() throws Exception {
        ...
        assertThat(deserializedMap.get("field5")).isEqualTo(kv);
    }
    ...
    void testEqualsAndHashCode() {
        ...
        DefaultUsage usage4 = new DefaultUsage(Integer.valueOf(100), Integer.valueOf(50), Integer.valueOf(150), kv);
