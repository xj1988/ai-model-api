...
/**
 * {@link StructuredOutputConverter} 使用
 * {@link DefaultConversionService} 的实现将LLM输出转换为
 * {@link java.util.List} 实例
 *
 * @author Mark Pollack
...
public class ListOutputConverter extends AbstractConversionServiceOutputConverter<List<String>> {
    ...
    public String getFormat() {
        return "Respond with only a list of comma-separated values, without any leading or trailing text. Example format: foo, bar, baz";
    }
